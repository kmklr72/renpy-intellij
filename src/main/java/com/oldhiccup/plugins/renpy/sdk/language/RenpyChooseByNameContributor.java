...
public class RenpyChooseByNameContributor implements ChooseByNameContributor {
  ...
  public NavigationItem[] getItemsByName(String name, String pattern, Project project, boolean includeNonProjectItems) {
    ...
    List<RenpyProperty> properties = com.oldhiccup.plugins.renpy.sdk.language.RenpyUtil.findProperties(project, name);
